...
*** trying a basic workflow with vc :week3:
...
Also and overall I didn't find ~vc~ commands to manipulate branches so I assume again we should use the command line for that.
